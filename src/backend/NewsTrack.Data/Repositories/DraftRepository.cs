...
{
    internal class DraftRepository : RepositoryBase<Model.Draft, Draft>, IDraftRepository
    {
        ...
        protected override Draft To(Model.Draft model)
        {
            return new Draft
            {
                ...
                Picture = new Uri(model.Picture, UriKind.Absolute),
        ...
        protected override Model.Draft From(Draft entity)
        {
            return new Model.Draft
            {
                ...
                Picture = entity.Picture.AbsoluteUri,
